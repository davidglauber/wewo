...
*/
  ...
  pixQRCODE() {
    ...
    this.setState({pixWebView:'loaded'});
    ...
    fetch('https://api.mercadopago.com/checkout/preferences', {
        ...
        body: JSON.stringify({
          ...
          back_urls: {
            ...
            failure: "https://www.mercadopago.com/mp.php"
          },
          payment_methods: {
      ...
      .then((res) => res.json())
      .then((json) => this.mpTaxPIXAndPayment(json.init_point, json))
  ...
  */
  ...
  _onNavigationStateChangePix(webViewState){
    var e = this;
    console.log('url: ' + webViewState.url)
    if(webViewState.url.includes('https://www.mercadopago.com/mp.php')) {
  ...
  render() {
    ...
    const endpointMPPix = this.state.endpointMPPix;
    ...
    return (
      <SafeBackground>
        ...
        />
        {this.state.brCodeValue == '' && this.state.pixWebView == '' &&
        ...
        {this.state.brCodeValue == '' && this.state.pixWebView !== '' &&
          <WebView 
            source={{ uri: endpointMPPix }} 
            onNavigationStateChange={this._onNavigationStateChangePix.bind(this)}
          />
        }
