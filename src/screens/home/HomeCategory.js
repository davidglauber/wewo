...
async componentDidMount() {
  ...
  render() {
   const { status, emailUserFunction, isFetchedButton, isFetchedPublish, categories, premiumPublishesAuto, premiumPublishesEstab, activesPublishesAuto, activesPublishesEstab, isFetched } = this.state
            ...
            <ScrollView alwaysBounceHorizontal={true} showsHorizontalScrollIndicator={false} horizontal={true} style={{padding:15}}>
                ...
                <FlatList
                  ...
                  <View style={{alignItems: 'center'}}>
                      <TouchCategory onPress={() => this.props.navigation.navigate('HomeCategory2', {titleOfCategory: item.titleCategory})} style={{width: windowWidth/5, height:55, alignItems:'center', marginTop: 20, justifyContent:'center', borderRadius:20, marginRight: 20}}>
